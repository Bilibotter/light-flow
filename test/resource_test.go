...
func TestNoRegisterResourceAttach(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach("NoExistResource", "***", nil).Step(), "2")
	...
	process.NamedStep(Fx[flow.Step](t).Attach("NoExistResource", "***", nil).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Wait().Acquire("NoExistResource", "***", nil).Step(), "3")
...
func TestResourceAttach(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach("TestResourceAttachResource", "***", map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Wait().Acquire("TestResourceAttachResource", nil, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "2")
	process.NamedStep(Fx[flow.Step](t).Acquire("TestResourceAttachResource", nil, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "3", "1")
	...
	// concurrent acquire
	for i := 4; i <= 20; i++ {
		process.NamedStep(Fx[flow.Step](t).Acquire("TestResourceAttachResource", nil, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), strconv.Itoa(i), "3")
	}
...
func TestResourceAttachInBeforeProcess(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Acquire("TestResourceAttachInBeforeProcess0", nil, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "1")
...
func TestResourceInitialize(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach(resName, initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Wait().Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "2")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "3", "1")
	wf.AfterFlow(false, CheckResult(t, 3, flow.Success))
...
func TestResourceInitializeError(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach(resName, initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	wf.AfterFlow(false, CheckResult(t, 0, flow.Error))
...
func TestResourceInitializePanic(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach(resName, initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "2", "1")
	wf.AfterFlow(false, CheckResult(t, 0, flow.Error))
...
func TestResourceUpdate(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Wait().Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "2")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "3", "1")
	process.NamedStep(func(ctx flow.Step) (any, error) {
		r, _ := ctx.Acquire(resName)
		r.Update("TestResourceUpdate0")
		atomic.AddInt64(&current, 1)
		return nil, nil
	}, "4", "2", "3")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, "TestResourceUpdate0", map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "5", "4")
...
func TestResourceRelease(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach("TestResourceRelease", initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Wait().Acquire("TestResourceRelease", initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "2")
	process.NamedStep(Fx[flow.Step](t).Acquire("TestResourceRelease", initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Step(), "3", "1")
...
func TestReleaseWhileStepError(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach(resName, initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Error().Step(), "1")
...
func TestReleaseWhileStepPanic(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach(resName, initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14}).Panic().Step(), "1")
...
func TestResourceRecover(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Attach(resName, initParam, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14, "person": Person{"Tom", 20}}).Broadcast().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Wait().SetCtx().Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14, "person": Person{"Tom", 20}}).Step(), "2")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14, "person": Person{"Tom", 20}}).Step(), "3", "1")
	process.NamedStep(Fn(t).Fail(CheckCtx("2")).Suc(CheckCtx("2")).ErrStep(), "4", "2")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14, "person": Person{"Tom", 20}}).Step(), "5", "4")
...
func TestResourceRecover0(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+resName, map[string]any{"int": 1, "str": "hello", "bool": true, "float": 3.14, "person": Person{"Tom", 20}}).Step(), "3", "1")
	process.NamedStep(Fn(t).Fail(CheckCtx("2")).Suc(CheckCtx("2")).ErrStep(), "4", "2")
	process.NamedStep(Fx[flow.Step](t).Acquire(resName, initParam+initParam+resName, map[string]any{"int": 10, "str": "hello0", "bool": false, "float": 33.14, "person": Person{"Amy", 21}}).Step(), "5", "4")
	wf.AfterFlow(false, CheckResult(t, 4, flow.Success)).If(execSuc)
