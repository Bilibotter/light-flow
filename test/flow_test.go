...
func TestMultipleExceptionStatus(t *testing.T) {
	...
	process.NamedStep(Fn(t).Errors(), "1")
	process.NamedStep(Fn(t).Panic(), "2")
	step := process.NamedStep(Fn(t).WaitLetGO(1), "3")
...
func TestSinglePanicStep(t *testing.T) {
	...
	process.NamedStep(GeneratePanicStep(1), "1")
...
func TestGoAheadWithoutDependPanicStep(t *testing.T) {
	...
	process.NamedStep(GeneratePanicStep(1), "1")
	process.NamedStep(GenerateStep(2), "2", "1")
	process.NamedStep(GenerateStep(3), "3", "2")
	process.NamedStep(GenerateStep(11), "11")
	process.NamedStep(GenerateStep(12), "12", "11")
	process.NamedStep(GenerateStep(13), "13", "12")
	process.NamedStep(GenerateStep(14), "14", "13")
...
func TestSingleErrorStep(t *testing.T) {
	...
	process.NamedStep(GenerateErrorStep(1), "1")
...
func TestTestMultipleNormalStepWithoutAlias(t *testing.T) {
	...
	process.NamedStep(NormalStep1, "4", NormalStep1)
	process.NamedStep(NormalStep1, "5", "NormalStep1")
...
func TestMultipleNormalStepWithMultipleBranches(t *testing.T) {
	...
	process.NamedStep(GenerateStep(2), "2", "1")
	process.NamedStep(GenerateStep(3), "3", "2")
	process.NamedStep(GenerateStep(4), "4", "2")
	process.NamedStep(GenerateStep(5), "5", "2")
...
func TestWorkFlowPause(t *testing.T) {
	...
	process.NamedStep(Fn(t).WaitLetGO(), "1w1")
	process.NamedStep(Fn(t).WaitLetGO(), "1w2", "1w1")
	process.NamedStep(Fn(t).WaitLetGO(), "1w3", "1w2")
	process.NamedStep(Fn(t).WaitLetGO(), "2w1")
	process.NamedStep(Fn(t).WaitLetGO(), "2w2", "2w1")
	process.NamedStep(Fn(t).WaitLetGO(), "2w3", "2w2")
	workflow.AfterFlow(false, CheckResult(t, 6, flow.Success))
...
func TestProcessPause(t *testing.T) {
	...
	fn := Fn(t)
	process.NamedStep(fn.WaitLetGO(), "1w1")
	process.NamedStep(fn.Normal(), "1w2", "1w1")
	process.NamedStep(fn.Normal(), "1w3", "1w2")
	process.NamedStep(fn.WaitLetGO(), "2w1")
	process.NamedStep(fn.Normal(), "2w2", "2w1")
	process.NamedStep(fn.Normal(), "2w3", "2w2")
	workflow.AfterFlow(false, CheckResult(t, 6, flow.Success))
...
func TestPanicStepLook(t *testing.T) {
	...
	process.NamedStep(Fn(t).Panic(), "1")
...
func TestStop(t *testing.T) {
	...
	process.NamedStep(Fn(t).WaitLetGO(), "1")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "2")
...
func TestSerial(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "01")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "02")
	process.Follow(NormalStep1)
...
func TestSyncPoint(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "NormalStep0")
	point := process.Parallel(NormalStep1, NormalStep2, NormalStep3).After("NormalStep0")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "NormalStep4", point)
	...
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "NormalStep5", point)
	...
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "NormalStep5", point, NormalStep3, NormalStep4)
	process.AfterStep(true, CheckCurrent(t, 6)).OnlyFor("NormalStep6")
	process.Flow().AfterFlow(true, CheckResult(t, 6, flow.Success))
