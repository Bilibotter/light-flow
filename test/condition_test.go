...
func TestUnComparablePanic(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Cond().Step(), "1")
	step := proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	defer func() {
		if r := recover(); r == nil {
...
func TestEQ(t *testing.T) {
	...
	step := proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	EQCondition(step)
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "1")
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4", "2", "3")
...
func TestIllegalOR(t *testing.T) {
	f1 := func() {
		...
		step := proc.NamedStep(Fx[flow.Step](t).Step(), "1")
		step.OR()
	}
	f1()
	f2 := func() {
...
func TestConditionRecover(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Cond().Step(), "1")
	step := proc.NamedStep(Fx[flow.Step](t).Recover().Step(), "2", "1")
	EQCondition(step)
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "1")
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4", "2", "3")
	...
	EQCondition(step)
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "1")
	proc.NamedStep(Fx[flow.Step](t).Recover().Step(), "4", "2", "3")
...
func TestConditionMergeWithSkip(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Cond().Step(), "1")
	step := proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4", "2")
	step.EQ("notExistKey", 1).SkipWithDependents()
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "2")
	...
	step = proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "5", "1")
	wf.AfterFlow(true, CheckResult(t, 2, flow.Success))
...
func TestConditionMergeWithAdd(t *testing.T) {
	...
	step := proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	EQCondition(step)
	step = proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "1")
	step.EQ("notExistKey", 1)
	step = proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4", "1")
	step.EQ("notExistKey", 1).SkipWithDependents()
	step = proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "5", "1")
	step.EQ("notExistKey", 1).SkipWithDependents("7")
	proc.NamedStep(Fx[flow.Step](t).Inc(100).Step(), "6", "4")
	proc.NamedStep(Fx[flow.Step](t).Inc(10).Step(), "7", "5")
	proc.NamedStep(Fx[flow.Step](t).Inc(10).Step(), "8", "2")
	...
	proc.NamedStep(Fx[flow.Step](t).Inc(1000).Step(), "9")
...
func TestConditionMultiMerge(t *testing.T) {
	...
	step = proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	step.EQ("notExistKey", 1)
	proc.NamedStep(Fx[flow.Step](t).Inc(10).Step(), "3", "2")
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4", "2")
	wf.AfterFlow(true, CheckResult(t, 11, flow.Success))
