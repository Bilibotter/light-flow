...
func TestCombineStepRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(SetCtx()).Step(), "step1").
...
func TestSeparateStepRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(SetCtx0("+")).Step(), "step2")
	proc.NamedStep(Fn(t).
		Suc(CheckCtx("step1"), CheckCtx0("step2", "+"), SetCtx(), SetCtx0("+")).ErrStep(),
		"step3", "step1", "step2")
	proc.NamedStep(Fn(t).Suc(CheckCtx("step3"), CheckCtx0("step3", "+")).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 2, flow.Success)).If(execSuc)
	wf.AfterStep(false, ErrorResultPrinter).If(execSuc)
...
func Test1ProcSuc1ProcRecover(t *testing.T) {
	...
	proc.NamedStep(GenerateStep(1), "step1").
...
func TestSingleStepRecoverWith2Branch(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(SetCtx()).Step(), "step2w1").
...
func TestRecoverSuccessFlow(t *testing.T) {
	...
	proc.NamedStep(Ck(t).SetFn(), "Step1").
...
func TestSingleStepRecoverWith1DependSuc1DependFail0(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(SetCtx0("+")).Step(), "step1w1")
	proc.NamedStep(Fn(t).Do(SetCtx()).Step(), "step1w2")
	...
	proc.NamedStep(Fn(t).Fail(SetCtx()).Suc(CheckCtx0("step2w1", "+"), CheckCtx("step2w2")).Step(),
		"step3w1", "step2w1", "step2w2")

	proc.NamedStep(Fn(t).Suc(CheckCtx("step2w2")).ErrStep(),
		"step3w2", "step2w2")
...
func TestSingleStepRecoverWith1DependSuc1DependFail(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(SetCtx()).Step(), "step1w1")
...
func TestPanicStepRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Fail(SetCtx(), f).Suc(CheckCtx("step1", 0)).Step(), "step1").
...
func TestMultipleStepRecover0(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Fail(SetCtx()).Suc(CheckCtx("step1w1", 0)).ErrStep(), "step1w1").
		Next(Fn(t).Do(CheckCtx("step1w1")).Step(), "1w2")
	proc.NamedStep(Fn(t).Suc(SetCtx()).ErrStep(), "step2w1").
...
func TestFlowInputRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestFlowInputRecover", 0)).Suc(SetCtx()).ErrStep(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	wf.AfterFlow(false, CheckResult(t, 4, flow.Success)).If(execSuc)
	wf.AfterStep(false, ErrorResultPrinter).If(execSuc)
	m := simpleContext{
...
func TestFlowCallbackSkipWhileRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestFlowCallbackSkipWhileRecover", 0)).Suc(SetCtx()).ErrStep(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
...
func TestPreFlowCallbackFailRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestFlowCallbackSkipWhileRecover", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
...
func TestProcessRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestProcessRecover", 0)).Suc(SetCtx()).ErrStep(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 5, flow.Success)).If(execSuc)
...
func TestPreProcessCallbackFailRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestPreProcessCallbackFailRecover", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 5, flow.Success)).If(execSuc)
...
func TestPreProcessCallbackFailRecover0(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestPreProcessCallbackFailRecover0", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 5, flow.Success)).If(execSuc)
...
func TestPreProcessCallbackFailRecover1(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestPreProcessCallbackFailRecover1", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 6, flow.Success)).If(execSuc)
...
func TestPreProcessCallbackFailRecover2(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestPreProcessCallbackFailRecover2", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 6, flow.Success)).If(execSuc)
...
func TestPreProcessCallbackPanicRecover2(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestPreProcessCallbackPanicRecover2", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 6, flow.Success)).If(execSuc)
...
func TestDefaultPreProcessCallbackFailRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Do(CheckCtx("TestDefaultPreProcessCallbackFailRecover", 0), SetCtx()).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
...
func TestProcessRecover1Suc1Fail(t *testing.T) {
	...
	proc1.NamedStep(Fn(t).Do(CheckCtx("TestProcessRecover1Suc1Fail1", 0)).Suc(SetCtx()).ErrStep(), "step1")
	proc1.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc1.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc1.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	proc1.BeforeProcess(false, Fn(t).Do(SetCtx()).Proc())

	proc2 := wf.Process("TestProcessRecover1Suc1Fail2")
	proc2.NamedStep(Fn(t).Normal(), "step2w1")
...
func TestStepInterruptRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Fail(SetCtx()).Suc(CheckCtx("step1w1", 0)).ErrStep(), "step1w1")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step2w1", "step1w1")
	proc.NamedStep(Fn(t).Normal(), "step1w2")
	proc.NamedStep(Fn(t).Normal(), "step2w2", "step1w2")
	wf.AfterFlow(false, CheckResult(t, 2, flow.Success)).If(execSuc)
	wf.AfterStep(false, ErrorResultPrinter).If(execSuc)
...
func TestStepBeforeCallbackFailRecover(t *testing.T) {
	...
	proc.BeforeStep(true, Fn(t).Fail(SetCtx()).Suc(CheckCtx("step1", 0)).ErrStepCall()).
		OnlyFor("step1")
	proc.NamedStep(Fn(t).Do(CheckCtx("step1", 0)).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
	wf.AfterFlow(false, CheckResult(t, 5, flow.Success)).If(execSuc)
...
func TestStepBeforeCallbackFailRecoverAnd2CommonStepCallback(t *testing.T) {
	...
	proc.BeforeStep(true, Fn(t).Fail(SetCtx()).Suc(CheckCtx("step1", 0)).ErrStepCall()).
		OnlyFor("step1")
	proc.BeforeStep(true, Fn(t).StepCall("proc"))
	proc.NamedStep(Fn(t).Do(SetCtx(), CheckCtx("step1", 0)).Step(), "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step2", "step1")
	proc.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "step3", "step2")
	proc.NamedStep(Fn(t).Do(CheckCtx1()).Step(), "step4", "step3")
...
func TestMultiTimesRecover0(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).MultiRecover(9).Step(), "step1")
...
func TestMultiTimesRecover(t *testing.T) {
	...
	proc.NamedStep(fx3.Inc().Step(), "step1")
	proc.NamedStep(fx5.Inc().Step(), "step2", "step1")
...
func TestTimeoutRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).WaitLetGO(1), "step1")
...
func TestStepAndCallbackFailedSameTimeRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Suc(CheckCtx0("1", "", 1)).Fail(SetCtx()).ErrStep(), "1")
	proc.NamedStep(Fn(t).Suc(CheckCtx("1")).Fail(SetCtx()).Step(), "2", "1")
...
func TestStepAndCallbackPanicSameTimeRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Suc(CheckCtx0("1", "", 1)).Fail(SetCtx()).PanicStep(), "1")
	proc.NamedStep(Fn(t).Suc(CheckCtx("1")).Fail(SetCtx()).Step(), "2", "1")
...
func TestDuplicateBreakPointRecover(t *testing.T) {
	...
	proc.NamedStep(Fn(t).Suc(CheckCtx0("1", "", 1)).Fail(SetCtx()).ErrStep(), "1")
	proc.NamedStep(Fn(t).Suc(CheckCtx("1")).Step(), "2", "1")
	proc.AfterStep(true, Fn(t).Suc(CheckCtx0("1", "", 1)).Fail(CheckCtx0("1", "", 1)).PanicStepCall()).
		OnlyFor("1")
	wf.AfterFlow(false, CheckResult(t, 3, flow.Success)).If(execSuc)
