...
func TestPreAndPostProcessor(t *testing.T) {
	...
	process.AliasStep(GenerateStep(4), "4", "3")
	process.BeforeStep(true, PreProcessor)
	process.AfterStep(true, PostProcessor)
	process.BeforeProcess(true, ProcProcessor)
	process.AfterProcess(true, ProcProcessor)
...
func TestWithShortProcessTimeout(t *testing.T) {
	...
	process.AliasStep(GenerateStep(4, "ms"), "4", "3")
...
func TestParallelWithLongDefaultStepTimeout(t *testing.T) {
	...
	process.AliasStep(GenerateStep(1), "1")
	process.AliasStep(GenerateStep(2), "2")
	process.AliasStep(GenerateStep(3), "3")
	process.AliasStep(GenerateStep(4), "4")
...
func TestAddStepTimeoutAndRetry(t *testing.T) {
	...
	proc.AliasStep(GenerateStep(1), "1")
...
func TestWithLongStepTimeout(t *testing.T) {
	...
	process.AliasStep(GenerateStep(1), "1").Retry(3).Timeout(1 * time.Second)
	process.AliasStep(GenerateStep(2), "2", "1")
	process.AliasStep(GenerateStep(3), "3", "2")
	process.AliasStep(GenerateStep(4), "4", "3")
...
func TestWithShortStepTimeout(t *testing.T) {
	...
	process.AliasStep(GenerateStep(1, "ms"), "1").Retry(3).Timeout(1 * time.Millisecond)
	process.AliasStep(GenerateStep(2, "ms"), "2", "1")
	process.AliasStep(GenerateStep(3, "ms"), "3", "2")
	process.AliasStep(GenerateStep(4, "ms"), "4", "3")
...
func TestSingleErrorStepWithStepRetry(t *testing.T) {
	...
	process.AliasStep(GenerateErrorStep(1), "1").Retry(3)
...
func TestSingleErrorStepWithProcessAndStepRetry(t *testing.T) {
	...
	process.StepsRetry(3)
	process.AliasStep(GenerateErrorStep(1), "1").Retry(2)
...
//	process.AliasStep(GenerateStep(1)).Config(&config, "1")
//	process.AliasStep(GenerateStep(2), "2", "1")
//	process.AliasStep(GenerateStep(3), "3", "2")
//	process.AliasStep(GenerateStep(4), "4", "3")
//	process.AliasStep(GenerateStep(5), "5", "4")
...
//	process.AliasStep(GenerateStep(1), "1")
//	process.AliasStep(GenerateStep(11), "11", "1")
//	process.AliasStep(GenerateStep(2), "2")
//	process.AliasStep(GenerateStep(12), "12", "2")
//	process.AliasStep(GenerateStep(3), "3")
//	process.AliasStep(GenerateStep(13), "13", "3")
//	process.AliasStep(GenerateStep(4), "4")
//	process.AliasStep(GenerateStep(14), "14", "4")
