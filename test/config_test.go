...
func TestProcessorWhenExceptionOccur(t *testing.T) {
	...
	process.NamedStep(GeneratePanicStep(2), "2")
	step := process.NamedStep(GenerateErrorStep(3, "ms"), "3")
...
func TestPreAndPostProcessor(t *testing.T) {
	...
	process.NamedStep(GenerateStep(4), "4", "3")
	process.BeforeStep(true, PreProcessor)
	process.AfterStep(true, PostProcessor)
	process.BeforeProcess(true, ProcProcessor)
	process.AfterProcess(true, ProcProcessor)
...
func TestWithShortProcessTimeout(t *testing.T) {
	...
	fn := Fn(t)
	process.NamedStep(fn.All(fn.WaitLetGO(), fn.Errors()), "1")
	process.NamedStep(fn.Normal(), "2", "1")
	process.NamedStep(fn.Normal(), "3", "2")
	process.NamedStep(fn.Normal(), "4", "3")
...
func TestParallelWithLongDefaultStepTimeout(t *testing.T) {
	...
	process.StepRetry(3)
	process.NamedStep(GenerateStep(1), "1")
	process.NamedStep(GenerateStep(2), "2")
	process.NamedStep(GenerateStep(3), "3")
	process.NamedStep(GenerateStep(4), "4")
	workflow.AfterFlow(false, CheckResult(t, 4, flow.Success))
...
func TestAddStepTimeoutAndRetry(t *testing.T) {
	...
	proc.NamedStep(GenerateStep(1), "1")
...
func TestWithLongStepTimeout(t *testing.T) {
	...
	process.NamedStep(GenerateStep(1), "1").StepRetry(3).StepTimeout(1 * time.Second)
	process.NamedStep(GenerateStep(2), "2", "1")
	process.NamedStep(GenerateStep(3), "3", "2")
	process.NamedStep(GenerateStep(4), "4", "3")
	workflow.AfterFlow(false, CheckResult(t, 4, flow.Success))
...
func TestWithShortStepTimeout(t *testing.T) {
	...
	fn := Fn(t)
	process.NamedStep(fn.All(fn.WaitLetGO(), fn.Errors()), "1").StepRetry(3).StepTimeout(1 * time.Nanosecond)
	process.NamedStep(fn.Normal(), "2", "1")
	process.NamedStep(fn.Normal(), "3", "2")
	process.NamedStep(fn.Normal(), "4", "3")
	workflow.AfterFlow(false, CheckResult(t, 1, flow.Timeout))
...
func TestSingleErrorStepWithStepRetry(t *testing.T) {
	...
	process.NamedStep(GenerateErrorStep(1), "1").StepRetry(2)
	workflow.AfterFlow(false, CheckResult(t, 3, flow.Error))
...
func TestSingleErrorStepWithProcessAndStepRetry(t *testing.T) {
	...
	process.StepRetry(2)
	process.NamedStep(GenerateErrorStep(1), "1").StepRetry(1)
