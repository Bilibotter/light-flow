...
func TestSearch(t *testing.T) {
	...
	process.AliasStep(invalidUse, "1")
	process.AliasStep(invalidUse, "2", "1")
	process.AliasStep(invalidUse, "3", "1")
	process.AliasStep(getUnExist, "4", "2", "3")
...
func TestPriorityWithSelf(t *testing.T) {
	...
	process.AliasStep(ChangeCtxStepFunc(&ctx1), "0")
	process.AliasStep(ChangeCtxStepFunc(&ctx1), "1")
	process.AliasStep(GenerateStepIncAddr(1), "2", "1")
	process.AliasStep(ChangeCtxStepFunc(&ctx2), "3", "1")
	step := process.AliasStep(GenerateStepIncAddr(1), "4", "2", "3")
	defer func() {
		if r := recover(); r != nil {
			t.Logf("%v", r)
		}
...
//	process.AfterStep(true, ErrorResultPrinter)
//	process.AliasStep(ExposeAddrFunc(&ctx1), "1")
//	process.AliasStep(GenerateStepIncAddr(2,"ms"), "2")
//	process.AliasStep(GenerateStepIncAddr(3,"ms"), "3")
//	process = workflow.Process("TestExpose2", nil)
//	process.AliasStep(ExposeAddrFunc(&ctx2), "11")
//	process.AliasStep(GenerateStepIncAddr(12,"ms"), "12")
//	process.AliasStep(GenerateStepIncAddr(13,"ms"), "13")
...
func TestPtrReuse(t *testing.T) {
	...
	process1.AliasStep(GenerateStepIncAddr(1), "1")
	process1.AliasStep(GenerateStepIncAddr(2), "2", "1")
	process1.AliasStep(GenerateStepIncAddr(3), "3", "2")
	process1 = workflow.Process("TestPtrReuse2")
	process1.AliasStep(GenerateStepIncAddr(11), "11")
	process1.AliasStep(GenerateStepIncAddr(12), "12", "11")
	process1.AliasStep(GenerateStepIncAddr(13), "13", "12")
...
func TestWaitToDoneInMultiple(t *testing.T) {
	...
	process2.AliasStep(GenerateStepIncAddr(11), "11")
	process2.AliasStep(GenerateStepIncAddr(12), "12", "11")
	process2.AliasStep(GenerateStepIncAddr(13), "13", "12")
	process2.AliasStep(GenerateSleep(100*time.Millisecond), "14", "13")
...
func TestProcessAndWorkflowCtx(t *testing.T) {
	...
	process.AfterStep(true, ErrorResultPrinter)
	process.AliasStep(GenerateStepIncAddr(1), "1")
	process.AliasStep(GenerateStepIncAddr(2), "2", "1")
	process.AliasStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestProcessAndWorkflowCtx2")
	process.AfterStep(true, ErrorResultPrinter)
	process.AliasStep(GenerateStepIncAddr(11), "11")
	process.AliasStep(GenerateStepIncAddr(12), "12", "11")
	process.AliasStep(GenerateStepIncAddr(13), "13", "12")
...
func TestStepCtx(t *testing.T) {
	...
	process.AliasStep(ChangeCtxStepFunc(&ctx3), "1")
	process.AliasStep(GenerateStepIncAddr(2), "2", "1")
	process.AliasStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestStepCtx2")
	process.AliasStep(ChangeCtxStepFunc(&ctx4), "11")
	process.AliasStep(GenerateStepIncAddr(12), "12", "11")
	process.AliasStep(GenerateStepIncAddr(13), "13", "12")
...
func TestDependStepCtx(t *testing.T) {
	...
	process.AfterStep(true, ErrorResultPrinter)
	process.AliasStep(ChangeCtxStepFunc(&ctx3), "1")
	process.AliasStep(ChangeCtxStepFunc(&ctx5), "2", "1")
	process.AliasStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestDependStepCtx2")
	process.AliasStep(ChangeCtxStepFunc(&ctx4), "11")
	process.AliasStep(ChangeCtxStepFunc(&ctx6), "12", "11")
	process.AliasStep(GenerateStepIncAddr(13), "13", "12")
