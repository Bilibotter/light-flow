...
func TestSearch(t *testing.T) {
	...
	process.NamedStep(invalidUse, "1")
	process.NamedStep(invalidUse, "2", "1")
	process.NamedStep(invalidUse, "3", "1")
	process.NamedStep(getUnExist, "4", "2", "3")
...
func TestRestrictWithSelf(t *testing.T) {
	...
	process.NamedStep(ChangeCtxStepFunc(&ctx1), "0")
	process.NamedStep(ChangeCtxStepFunc(&ctx1), "1")
	process.NamedStep(GenerateStepIncAddr(1), "2", "1")
	process.NamedStep(ChangeCtxStepFunc(&ctx2), "3", "1")
	step := process.NamedStep(GenerateStepIncAddr(1), "4", "2", "3")
	defer func() {
		if r := recover(); r != nil {
			t.Logf("%v", r)
		}
...
func TestPtrReuse(t *testing.T) {
	...
	process1.NamedStep(GenerateStepIncAddr(1), "1")
	process1.NamedStep(GenerateStepIncAddr(2), "2", "1")
	process1.NamedStep(GenerateStepIncAddr(3), "3", "2")
	process1 = workflow.Process("TestPtrReuse2")
	process1.NamedStep(GenerateStepIncAddr(11), "11")
	process1.NamedStep(GenerateStepIncAddr(12), "12", "11")
	process1.NamedStep(GenerateStepIncAddr(13), "13", "12")
...
func TestWaitToDoneInMultiple(t *testing.T) {
	...
	process2.NamedStep(GenerateStepIncAddr(11), "11")
	process2.NamedStep(GenerateStepIncAddr(12), "12", "11")
	process2.NamedStep(GenerateStepIncAddr(13), "13", "12")
	process2.NamedStep(GenerateSleep(100*time.Millisecond), "14", "13")
...
func TestProcessAndWorkflowCtx(t *testing.T) {
	...
	process.AfterStep(true, ErrorResultPrinter)
	process.NamedStep(GenerateStepIncAddr(1), "1")
	process.NamedStep(GenerateStepIncAddr(2), "2", "1")
	process.NamedStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestProcessAndWorkflowCtx2")
	process.AfterStep(true, ErrorResultPrinter)
	process.NamedStep(GenerateStepIncAddr(11), "11")
	process.NamedStep(GenerateStepIncAddr(12), "12", "11")
	process.NamedStep(GenerateStepIncAddr(13), "13", "12")
	workflow.AfterFlow(false, CheckCtxResult(t, 6, flow.Success))
...
func TestStepCtx(t *testing.T) {
	...
	process.NamedStep(ChangeCtxStepFunc(&ctx3), "1")
	process.NamedStep(GenerateStepIncAddr(2), "2", "1")
	process.NamedStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestStepCtx2")
	process.NamedStep(ChangeCtxStepFunc(&ctx4), "11")
	process.NamedStep(GenerateStepIncAddr(12), "12", "11")
	process.NamedStep(GenerateStepIncAddr(13), "13", "12")
	workflow.AfterFlow(false, CheckCtxResult(t, 0, flow.Success))
...
func TestDependStepCtx(t *testing.T) {
	...
	process.AfterStep(true, ErrorResultPrinter)
	process.NamedStep(ChangeCtxStepFunc(&ctx3), "1")
	process.NamedStep(ChangeCtxStepFunc(&ctx5), "2", "1")
	process.NamedStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestDependStepCtx2")
	process.NamedStep(ChangeCtxStepFunc(&ctx4), "11")
	process.NamedStep(ChangeCtxStepFunc(&ctx6), "12", "11")
	process.NamedStep(GenerateStepIncAddr(13), "13", "12")
	workflow.AfterFlow(false, CheckCtxResult(t, 0, flow.Success))
