...
func TestCallbackErrorEvent(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "1")
...
func TestSuspendEncryptErrorEvent(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).SetCtx().Recover().Step(), "1")
	...
	process.NamedStep(Fx[flow.Step](t).Inc().Recover().Step(), "1")
...
func TestRecoverPersistErrorEvent(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).SetCtx().Recover().Step(), "1")
...
func TestResourceEvent(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent0", nil, nil).Step(), "1")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent1", nil, nil).Step(), "1")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent2", nil, nil).Step(), "1")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent3", nil, nil).Step(), "1")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent4", nil, nil).Step(), "1")
	proc.NamedStep(Fx[flow.Step](t).Recover().Step(), "2")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent5", nil, nil).Step(), "1")
	proc.NamedStep(Fx[flow.Step](t).Recover().Step(), "2", "1")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent6", nil, nil).Step(), "1")
	proc.NamedStep(Fx[flow.Step](t).Recover().Step(), "2", "1")
	...
	proc.NamedStep(Fx[flow.Step](t).Attach("TestResourceEvent7", nil, nil).Step(), "1")
	proc.NamedStep(Fx[flow.Step](t).Recover().Step(), "2", "1")
