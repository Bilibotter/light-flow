...
func TestNormalPersist(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2", "1")
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3", "1")
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4", "1", "3")
...
func TestCallbackFailedPersist(t *testing.T) {
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "0")
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "2")
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "3")
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "4")
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "5")
	...
	proc.NamedStep(Fx[flow.Step](t).Inc().Step(), "6")
