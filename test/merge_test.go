...
func TestDependMergedWithEmptyHead(t *testing.T) {
	...
	fn := Fn(t)
	process1.NamedStep(fn.SetCtx0("1").Step(), "1")
	process1.NamedStep(fn.SetCtx0("2").Step(), "2", "1")
	process1.NamedStep(fn.SetCtx0("3").Step(), "3", "2")
	process1.NamedStep(fn.SetCtx0("4").Step(), "4", "3")
...
func TestDependMergedWithNotEmptyHead(t *testing.T) {
	...
	process1.NamedStep(Fn(t).Do(SetCtx()).Step(), "1")
	process1.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "2", "1")
	process1.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "3", "2")
	process1.NamedStep(Fn(t).Do(CheckCtx1(), SetCtx()).Step(), "4", "3")
	workflow1.AfterFlow(false, CheckResult(t, 4, flow.Success))
	...
	process2.NamedStep(Fn(t).Do(SetCtx0("+")).Step(), "0")
	process2.Merge("TestDependMergedWithNotEmptyHead1")
	process2.NamedStep(Fn(t).Do(CheckCtx0("0", "+"), CheckCtx("4")).Step(), "5", "0", "4")
	workflow2.AfterStep(false, ErrorResultPrinter)
...
func TestMergeEmpty(t *testing.T) {
	...
	process2.NamedStep(GenerateStep(1), "1")
	process2.NamedStep(GenerateStep(2), "2", "1")
	process2.NamedStep(GenerateStep(3), "3", "2")
	process2.NamedStep(GenerateStep(4), "4", "3")
...
func TestEmptyMerge(t *testing.T) {
	...
	process1.NamedStep(Fx[flow.Step](t).SetCtx().Step(), "1")
	process1.NamedStep(Fx[flow.Step](t).CheckDepend().SetCtx().Step(), "2", "1")
	process1.NamedStep(Fx[flow.Step](t).CheckDepend().SetCtx().Step(), "3", "2")
	process1.NamedStep(Fx[flow.Step](t).CheckDepend().SetCtx().Step(), "4", "3")
...
func TestMergeAbsolutelyDifferent(t *testing.T) {
	...
	process1.NamedStep(GenerateStep(1), "1")
	process1.NamedStep(GenerateStep(2), "2", "1")
	process1.NamedStep(GenerateStep(3), "3", "2")
	process1.NamedStep(GenerateStep(4), "4", "3")
	...
	process2.NamedStep(GenerateStep(11), "11")
	process2.NamedStep(GenerateStep(12), "12", "11")
	process2.NamedStep(GenerateStep(13), "13", "12")
	process2.NamedStep(GenerateStep(14), "14", "13")
...
func TestMergeLayerSame(t *testing.T) {
	...
	process1.NamedStep(GenerateStep(1), "1")
	process1.NamedStep(GenerateStep(2), "2", "1")
	process1.NamedStep(GenerateStep(3), "3", "1")
	process1.NamedStep(GenerateStep(4), "4", "3")
	factory1.AfterFlow(false, CheckResult(t, 4, flow.Success))
	factory2 := flow.RegisterFlow("TestMergeLayerSame2")
	process2 := factory2.Process("TestMergeLayerSame2")
	process2.NamedStep(GenerateStep(1), "1")
	process2.NamedStep(GenerateStep(3), "3", "1")
	process2.NamedStep(GenerateStep(4), "4", "3")
	process2.NamedStep(GenerateStep(5), "5", "4")
...
func TestMergeLayerDec(t *testing.T) {
	...
	process2.NamedStep(GenerateStep(1), "1")
	process2.NamedStep(GenerateStep(4), "4", "1")
	process2.NamedStep(GenerateStep(5), "5", "4")
	process2.NamedStep(GenerateStep(6), "6", "5")
...
func TestMergeLayerInc(t *testing.T) {
	...
	process2.NamedStep(GenerateStep(1), "1")
	process2.NamedStep(GenerateStep(3), "3", "1")
	process2.NamedStep(GenerateStep(5), "5", "3")
...
func TestMergeSomeSame(t *testing.T) {
	...
	process2.NamedStep(GenerateStep(1), "1")
	process2.NamedStep(GenerateStep(5), "5", "1")
	process2.NamedStep(GenerateStep(3), "3", "5")
	process2.NamedStep(GenerateStep(4), "4", "5")
...
func TestMergeCircle(t *testing.T) {
	...
	process2.NamedStep(GenerateStep(2), "2")
	process2.NamedStep(GenerateStep(1), "1", "2")
	defer func() {
		if r := recover(); r != nil {
...
func TestAddWaitBeforeAfterMergeWithCircle(t *testing.T) {
	...
	tmp := process2.NamedStep(GenerateStep(5), "5")
...
func TestAddWaitAllAfterMergeWithCircle(t *testing.T) {
	...
	process2.NamedStep(GenerateStep(5), "5")
...
func TestSerialMerge(t *testing.T) {
	...
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "1")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "2")
	process.NamedStep(Fx[flow.Step](t).Inc().Step(), "3")
