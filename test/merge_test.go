...
func TestDependMergedWithEmptyHead(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestDependMergedWithEmptyHead1", nil)
	...
	process2 := factory2.AddProcessWithConf("TestDependMergedWithEmptyHead2", nil)
...
func TestDependMergedWithNotEmptyHead(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestDependMergedWithNotEmptyHead1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "2")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestDependMergedWithNotEmptyHead2")
	process2 := factory2.AddProcessWithConf("TestDependMergedWithNotEmptyHead2", nil)
...
func TestMergeEmpty(t *testing.T) {
	...
	factory1.AddProcessWithConf("TestMergeEmpty1", nil)
	factory2 := flow.RegisterFlow("TestMergeEmpty2")
	process2 := factory2.AddProcessWithConf("TestMergeEmpty2", nil)
...
func TestEmptyMerge(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestEmptyMerge1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "2")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestEmptyMerge2")
	process2 := factory2.AddProcessWithConf("TestEmptyMerge2", nil)
...
func TestMergeAbsolutelyDifferent(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeAbsolutelyDifferent1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "2")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestMergeAbsolutelyDifferent2")
	process2 := factory2.AddProcessWithConf("TestMergeAbsolutelyDifferent2", nil)
...
func TestMergeLayerSame(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeLayerSame1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "1")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestMergeLayerSame2")
	process2 := factory2.AddProcessWithConf("TestMergeLayerSame2", nil)
	process2.AddStepWithAlias("1", GenerateStep(1))
...
func TestMergeLayerDec(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeLayerDec1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "1")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestMergeLayerDec2")
	process2 := factory2.AddProcessWithConf("TestMergeLayerDec2", nil)
	process2.AddStepWithAlias("1", GenerateStep(1))
...
func TestMergeLayerInc(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeLayerInc1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "1")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestMergeLayerInc2")
	process2 := factory2.AddProcessWithConf("TestMergeLayerInc2", nil)
	process2.AddStepWithAlias("1", GenerateStep(1))
	process2.AddStepWithAlias("3", GenerateStep(3), "1")
...
func TestMergeSomeSame(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeSomeSame1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "1")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestMergeSomeSame2")
	process2 := factory2.AddProcessWithConf("TestMergeSomeSame2", nil)
	process2.AddStepWithAlias("1", GenerateStep(1))
...
func TestMergeSame(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeSame1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "2")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	factory2 := flow.RegisterFlow("TestMergeSame2")
	process2 := factory2.AddProcessWithConf("TestMergeSame2", nil)
	process2.AddStepWithAlias("1", GenerateStep(1))
	process2.AddStepWithAlias("2", GenerateStep(2), "1")
	process2.AddStepWithAlias("3", GenerateStep(3), "2")
	process2.AddStepWithAlias("4", GenerateStep(4), "3")
...
func TestMergeCircle(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeCircle1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	factory2 := flow.RegisterFlow("TestMergeCircle2")
	process2 := factory2.AddProcessWithConf("TestMergeCircle2", nil)
...
func TestMergeLongCircleLongCircle(t *testing.T) {
	...
	process1 := factory1.AddProcessWithConf("TestMergeLongCircle1", nil)
	process1.AddStepWithAlias("1", GenerateStep(1))
	process1.AddStepWithAlias("2", GenerateStep(2), "1")
	process1.AddStepWithAlias("3", GenerateStep(3), "2")
	process1.AddStepWithAlias("4", GenerateStep(4), "3")
	...
	process2 := factory2.AddProcessWithConf("TestMergeLongCircle2", nil)
	process2.AddStepWithAlias("2", GenerateStep(2))
