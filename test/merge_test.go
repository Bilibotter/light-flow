...
func TestMergeEmpty(t *testing.T) {
	...
	process2.NameStep(GenerateStep(1), "1")
	process2.NameStep(GenerateStep(2), "2", "1")
	process2.NameStep(GenerateStep(3), "3", "2")
	process2.NameStep(GenerateStep(4), "4", "3")
...
func TestEmptyMerge(t *testing.T) {
	...
	process1.NameStep(Fx[flow.Step](t).SetCtx().Step(), "1")
	process1.NameStep(Fx[flow.Step](t).CheckDepend().SetCtx().Step(), "2", "1")
	process1.NameStep(Fx[flow.Step](t).CheckDepend().SetCtx().Step(), "3", "2")
	process1.NameStep(Fx[flow.Step](t).CheckDepend().SetCtx().Step(), "4", "3")
...
func TestMergeAbsolutelyDifferent(t *testing.T) {
	...
	process2.NameStep(GenerateStep(11), "11")
	process2.NameStep(GenerateStep(12), "12", "11")
	process2.NameStep(GenerateStep(13), "13", "12")
	process2.NameStep(GenerateStep(14), "14", "13")
...
func TestMergeLayerDec(t *testing.T) {
	...
	process2.NameStep(GenerateStep(1), "1")
	process2.NameStep(GenerateStep(4), "4", "1")
	process2.NameStep(GenerateStep(5), "5", "4")
	process2.NameStep(GenerateStep(6), "6", "5")
...
func TestMergeLayerInc(t *testing.T) {
	...
	process2.NameStep(GenerateStep(1), "1")
	process2.NameStep(GenerateStep(3), "3", "1")
	process2.NameStep(GenerateStep(5), "5", "3")
...
func TestMergeSomeSame(t *testing.T) {
	...
	process2.NameStep(GenerateStep(1), "1")
	process2.NameStep(GenerateStep(5), "5", "1")
	process2.NameStep(GenerateStep(3), "3", "5")
	process2.NameStep(GenerateStep(4), "4", "5")
...
func TestMergeCircle(t *testing.T) {
	...
	process2.NameStep(GenerateStep(2), "2")
	process2.NameStep(GenerateStep(1), "1", "2")
	defer func() {
		if r := recover(); r != nil {
...
func TestAddWaitBeforeAfterMergeWithCircle(t *testing.T) {
	...
	tmp := process2.NameStep(GenerateStep(5), "5")
...
func TestAddWaitAllAfterMergeWithCircle(t *testing.T) {
	...
	process2.NameStep(GenerateStep(5), "5")
