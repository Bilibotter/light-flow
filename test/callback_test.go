...
func TestInfoCorrect(t *testing.T) {
	...
	process.NamedStep(Ck(t).SetFn(), "Step1")
	process.NamedStep(Ck(t).SetFn(), "Step2", "Step1")
	process.NamedStep(Ck(t).SetFn(), "Step3", "Step1")
	process.NamedStep(Ck(t).SetFn(), "Step4", "Step2", "Step3")
...
func TestDefaultProcessConfig(t *testing.T) {
	...
	process.NamedStep(Fn(t).Normal(), "1")
	process.NamedStep(Fn(t).Normal(), "2", "1")
	process.NamedStep(Fn(t).Normal(), "3", "2")
	process.NamedStep(Fn(t).Normal(), "4", "3")
